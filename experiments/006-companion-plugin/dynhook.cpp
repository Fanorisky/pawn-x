...
int AmxLoad(AMX *amx)   { g_Register(amx, dynhook_Natives, -1); return 0; }
int AmxUnload(AMX *amx) { (void)amx; return 0; }
int Unload(void)        { g_chains.clear(); return 0; }
